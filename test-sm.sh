...
export RUSTFLAGS="-Z pre-link-arg=-L$(pwd) -Z pre-link-arg=-lsm_Clib -C link-arg=-Wl,--start-group -C link-arg=-lmachine -C link-arg=-lutil -C link-arg=-lsm_Clib -C link-arg=-Wl,--end-group"
